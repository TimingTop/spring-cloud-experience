...
public class GrammarStateManager {
    ...
    public void addTransition(GrammarState from, GrammarState to, int on) {
    	...
    	from.print();
    	System.out.println("on: " + top.dianmu.ccompiler.day34.top.dianmu.ccompiler.day36.top.dianmu.ccompiler.day38.top.dianmu.ccompiler.day40.top.dianmu.ccompiler.day52.Compiler.Compiler.top.dianmu.ccompiler.day40.top.dianmu.ccompiler.day52.Compiler.SymbolDefine.getSymbolStr(on) + " to : ");
    	to.print();
    	*/
    ...
    public void printReduceInfo() {
        ...
        for(Map.Entry<GrammarState, HashMap<Integer, GrammarState>> item : transitionMap.entrySet()) {
