package com.timing.experience.os.p9_2;
...
public class OperatingSystem {
    ...
    public void makeFllopy()   {
        ...
        writeFileToFloppy("src/main/resources/p9_2/kernel.bat", false, 1, 2);

        floppyDisk.makeFloppy("src/main/resources/p9_2/system.img");
    }

    public static void main(String[] args) {
        OperatingSystem op = new OperatingSystem("src/main/resources/p9_2/boot.bat");
        op.makeFllopy();
    }
