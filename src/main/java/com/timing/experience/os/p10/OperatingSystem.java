package com.timing.experience.os.p10;
...
public class OperatingSystem {
    ...
    private static final String path = "src/main/resources/p10/";
    ...
    public void makeFllopy()   {
        ...
        writeFileToFloppy(path + "kernel.bat", false, 1, 2);

        floppyDisk.makeFloppy(path + "system.img");
    }

    public static void main(String[] args) {
        OperatingSystem op = new OperatingSystem(path + "boot.bat");
        op.makeFllopy();
    }
