package com.timing.experience.os.p6;
...
public class OperatingSystem {
    ...
    public void makeFllopy()   {
        ...
        writeFileToFloppy("src/main/resources/p6/kernel.bat", false, 1, 2);

        floppyDisk.makeFloppy("src/main/resources/p6/system.img");
    }

    public static void main(String[] args) {
        OperatingSystem op = new OperatingSystem("src/main/resources/p6/boot.bat");
        op.makeFllopy();
    }
