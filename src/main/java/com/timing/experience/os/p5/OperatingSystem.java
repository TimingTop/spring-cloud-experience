package com.timing.experience.os.p5;
...
public class OperatingSystem {
    ...
    public void makeFllopy()   {
        ...
        writeFileToFloppy("src/main/resources/p5/kernel.bat", false, 1, 2);

        floppyDisk.makeFloppy("src/main/resources/p5/system.img");
    }

    public static void main(String[] args) {
        OperatingSystem op = new OperatingSystem("src/main/resources/p5/boot.bat");
        op.makeFllopy();
    }
