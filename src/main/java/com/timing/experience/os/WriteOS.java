package com.timing.experience.os;

import java.io.*;
import java.util.ArrayList;

public class WriteOS {
    ...
    public static void main(String[] args) {
        WriteOS op = new WriteOS("hello, this is my first line of my operating system code");
        op.makeFllopy();
    }
}
